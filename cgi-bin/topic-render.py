...
print '<H1><A HREF="topicindex-model.html">Free Speech Board</A></H1>'
print '<H4 CLASS="western"><I>You are on Node #1. (<A HREF="about-model.html">More'
print 'Information</A>)</I></H4>'
print '<H4 CLASS="western"><A HREF="topicindex-model.html">Back to List of'
print 'Topics</A></H4>'
...
print '	</TR>'
print '</TABLE>'
print '<form action = "cgi-bin/addmsg.py" method = "get">'
print '  Message:</br>'
